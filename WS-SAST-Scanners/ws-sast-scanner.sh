...
# curl --output ${reportdir}/${repo}.html --request POST ${SAST_SERVER}'/api/scans/'${SCAN_ID}'/report?format=html' -H 'X-Auth-Token: '${SASTCLI_TOKEN} -H 'Content-Type: application/json' \
